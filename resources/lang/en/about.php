...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | About Page Front End Language Lines
    |--------------------------------------------------------------------------
    */

    'title' => 'Dryas Library | About',
    'heading' => 'Read',
    'booktitlechild1' => ' and Feel.',
    'bookdesc1' => 'Explore up to 100,000 more book titles that are available online and offline and
    immediately feel the pleasure when reading it.',
    'catalog' => 'See Catalog',
    'provisiondesc1' => 'XYZ university library is a fairly large library that has
    ...
    the is on borrowed status. Librarians strive to ensure that books are
    ...
    'provisiondesc2' => 'A book can be borrowed for a maximum of 21 days. At all times,
    ...
    'provisiondesc3' => 'To become a member of the library, applicants must fill out a form that contains

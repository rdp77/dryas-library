...
@section('title', __('Dryas Library | Register'))
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                placeholder="Your e-mail" value="{{ old('email') }}" required autocomplete="email">
            @error('email')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
            ...
            <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address"
                placeholder="Your address" value="{{ old('address') }}" required autocomplete="address">
            @error('address')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
            ...
            <input id="tlp" type="text" class="form-control @error('tlp') is-invalid @enderror" name="tlp"
                placeholder="Your telepon" data-inputmask="&quot;mask&quot;: &quot;(+62) 999-9999-9999&quot;"
                value="{{ old('tlp') }}" required autocomplete="tlp">
            @error('tlp')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
